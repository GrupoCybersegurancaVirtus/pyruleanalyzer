...
With the :class:`PyRuleAnalyzer<pyruleanalyzer.PyRuleAnalyzer>` instance in hands, we can now execute a rule refinement, which will refine the tree by removing duplicate rules.

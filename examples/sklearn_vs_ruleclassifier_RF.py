...
classifier = RuleClassifier.new_classifier(train_path, test_path, model_params, algorithm_type='Random Forest')
...
# ==============================================================================
print("\n" + "="*80)
print(f"RELATÓRIO DE COMPARAÇÃO DE DESEMPENHO: SKLEARN (RF) vs NATIVE PYTHON")
print("="*80)

"""
Comprehensive Gradient Boosting Decision Trees invariant tests for pyruleanalyzer.
...
def sklearn_predict_gbdt(train_path, test_path, model_params):
    ...
    Returns:
        Tuple of (y_pred, y_test, model, feature_names, X_test, class_names).
    """
    ...
    # Fit with DataFrame so feature_names_in_ is set (matches new_classifier behavior)
    X_train_df = pd.DataFrame(X_train, columns=feature_names)
    model.fit(X_train_df, np.asarray(y_train))
...
def build_gbdt_classifier(model, feature_names, class_names):
    ...
    Mirrors the new_classifier() GBDT path: extract rules, construct
    RuleClassifier, set metadata, compile native model.
    ...
    Returns:
        RuleClassifier instance with GBDT metadata.
    """
    rules, init_scores, is_binary, gbdt_classes = \
        RuleClassifier.get_gbdt_rules(model, feature_names, class_names)

    classifier = RuleClassifier(rules, algorithm_type='Gradient Boosting Decision Trees')
    classifier._gbdt_init_scores = init_scores # type: ignore
    classifier._gbdt_is_binary = is_binary
    classifier._gbdt_classes = gbdt_classes # type: ignore
...
def count_gbdt_leaves(model):
    ...
    Returns:
        Total number of leaves (including init rules).
    """
    n_estimators, n_cols = model.estimators_.shape
    total = sum(
        model.estimators_[i, j].get_n_leaves()
        for i in range(n_estimators)
        for j in range(n_cols)
    )
    # Add init rules (1 per class for multiclass, 1 for binary)
...
# Using fewer estimators and shallow depths to keep tests fast
TEST_CONFIGS = [
    # --- Binary classification ---
    (
        'GBDT_binary_500_depth3',
        dict(n_train=500, n_test=200, n_features=4, n_classes=2, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=3, learning_rate=0.1),
    ),
    (
        'GBDT_binary_500_depth5',
        dict(n_train=500, n_test=200, n_features=4, n_classes=2, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=5, learning_rate=0.1),
    ),
    (
        'GBDT_binary_500_defaultDepth',
        dict(n_train=500, n_test=200, n_features=4, n_classes=2, random_state=42),
        dict(n_estimators=10, random_state=42, learning_rate=0.1),
    ),
    (
        'GBDT_binary_800_noisy',
        dict(n_train=800, n_test=200, n_features=6, n_classes=2, random_state=7, noise=0.15),
        dict(n_estimators=15, random_state=42, max_depth=3, learning_rate=0.1),
    ),
    (
        'GBDT_binary_1000_20feat',
        dict(n_train=1000, n_test=300, n_features=20, n_classes=2, random_state=99),
        dict(n_estimators=10, random_state=42, max_depth=4, max_features='sqrt', learning_rate=0.1),
    ),
    (
        'GBDT_binary_1000_minLeaf20',
        dict(n_train=1000, n_test=300, n_features=5, n_classes=2, random_state=42),
        dict(n_estimators=10, random_state=42, min_samples_leaf=20, learning_rate=0.1),
    ),
    (
        'GBDT_binary_1000_30est',
        dict(n_train=1000, n_test=300, n_features=5, n_classes=2, random_state=42),
        dict(n_estimators=30, random_state=42, max_depth=3, learning_rate=0.1),
    ),
    (
        'GBDT_binary_600_categorical',
        dict(n_train=600, n_test=200, n_features=6, n_classes=2, random_state=42, categorical=True),
        dict(n_estimators=10, random_state=42, max_depth=4, learning_rate=0.1),
    ),
    (
        'GBDT_binary_500_highLR',
        dict(n_train=500, n_test=200, n_features=4, n_classes=2, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=3, learning_rate=0.5),
    ),

    # --- Multiclass ---
    (
        'GBDT_multi3_600_depth3',
        dict(n_train=600, n_test=200, n_features=5, n_classes=3, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=3, learning_rate=0.1),
    ),
    (
        'GBDT_multi3_600_depth5',
        dict(n_train=600, n_test=200, n_features=5, n_classes=3, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=5, learning_rate=0.1),
    ),
    (
        'GBDT_multi3_800_noisy',
        dict(n_train=800, n_test=200, n_features=5, n_classes=3, random_state=11, noise=0.1),
        dict(n_estimators=10, random_state=42, max_depth=3, learning_rate=0.1),
    ),
    (
        'GBDT_multi5_1000_depth3',
        dict(n_train=1000, n_test=300, n_features=8, n_classes=5, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=3, learning_rate=0.1),
    ),
    (
        'GBDT_multi5_2000_depth5',
        dict(n_train=2000, n_test=500, n_features=8, n_classes=5, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=5, learning_rate=0.1),
    ),
    (
        'GBDT_multi5_1000_20est',
        dict(n_train=1000, n_test=300, n_features=8, n_classes=5, random_state=42),
        dict(n_estimators=20, random_state=42, max_depth=3, learning_rate=0.1),
    ),
    ...
    (
        ...
        dict(n_estimators=5, random_state=42, max_depth=2, learning_rate=0.1),
    ),
    (
        'GBDT_binary_500_1feat',
        dict(n_train=500, n_test=200, n_features=1, n_classes=2, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=3, learning_rate=0.1),
    ),
    (
        'GBDT_binary_200_overfit',
        dict(n_train=200, n_test=100, n_features=10, n_classes=2, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=8, min_samples_leaf=1, learning_rate=0.3),
    ),
    (
        'GBDT_multi3_1000_maxLeaf10',
        dict(n_train=1000, n_test=300, n_features=5, n_classes=3, random_state=42),
        dict(n_estimators=10, random_state=42, max_leaf_nodes=10, learning_rate=0.1),
    ),
    (
        'GBDT_binary_1000_lowLR',
        dict(n_train=1000, n_test=300, n_features=5, n_classes=2, random_state=42),
        dict(n_estimators=20, random_state=42, max_depth=3, learning_rate=0.01),
    ),

    # ── Large-scale configs ──────────────────────────────────────────────
    (
        'GBDT_binary_10k_depth3',
        dict(n_train=10000, n_test=10000, n_features=6, n_classes=2, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=3, learning_rate=0.1),
    ),
    (
        'GBDT_binary_10k_depth5',
        dict(n_train=10000, n_test=10000, n_features=6, n_classes=2, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=5, learning_rate=0.1),
    ),
    (
        'GBDT_multi3_10k_depth3',
        dict(n_train=10000, n_test=10000, n_features=6, n_classes=3, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=3, learning_rate=0.1),
    ),
    (
        'GBDT_multi5_10k_15feat',
        dict(n_train=10000, n_test=10000, n_features=15, n_classes=5, random_state=42),
        dict(n_estimators=10, random_state=42, max_depth=4, learning_rate=0.1),
    ),
    (
        'GBDT_binary_10k_noisy',
        dict(n_train=10000, n_test=10000, n_features=8, n_classes=2, noise=0.3, random_state=42),
        dict(n_estimators=15, random_state=42, max_depth=4, learning_rate=0.1),
    ),
]
...
def run_test_config(name, dataset_kwargs, model_params, verbose=True):
    ...
    try:
        ...
        # 2. Train sklearn GBDT for reference
        y_sklearn, y_test, sk_model, feature_names, X_test, class_names = \
            sklearn_predict_gbdt(train_path, test_path, model_params)

        n_test = len(y_test)
        n_leaves_total = count_gbdt_leaves(sk_model)
        n_estimators, n_cols = sk_model.estimators_.shape

        results['details']['n_test'] = n_test
        results['details']['n_leaves_total'] = n_leaves_total
        results['details']['n_estimators'] = sk_model.get_params()['n_estimators']
        results['details']['n_cols'] = n_cols
        ...
        try:
            classifier = build_gbdt_classifier(sk_model, feature_names, class_names)
        finally:
            sys.stdout.close()
        ...
        # Test classify_gbdt (iterative)
        y_rule_initial = rule_classify_all_gbdt(
        ...
        for threshold in thresholds:
            ...
            y_t = rule_classify_all_gbdt(
                clf_t, X_test, feature_names, clf_t.final_rules
            )
...
def print_results(results):
    ...
    if 'n_test' in d:
        print(f'  Samples: {d["n_test"]} | '
              f'Sklearn leaves (total): {d.get("n_leaves_total", "?")} | '
              f'Estimators: {d.get("n_estimators", "?")} x {d.get("n_cols", "?")} cols | '
...
if __name__ == '__main__':
    print('=' * 80)
    print('PYRULEANALYZER - GRADIENT BOOSTING DECISION TREES INVARIANT TESTS')
    print('=' * 80)
